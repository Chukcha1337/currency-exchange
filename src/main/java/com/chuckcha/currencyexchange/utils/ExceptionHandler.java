...
public class ExceptionHandler {
    ...
    public static void handleExeptions(HttpServletResponse resp, Throwable throwable) throws IOException {
    ...
    public static RuntimeException handleSQLException(SQLException exception) {
        ...
        switch (sqlState) {
            case NOT_NULL_VIOLATION -> throw new DataNotFoundException("One or more currencies' codes are null");
            case FOREIGN_KEY_VIOLATION -> throw new DataNotFoundException("One or more currencies are not exist in the database");
